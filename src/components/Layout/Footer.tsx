...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/rztransportesmx/",
      icon: (
    ...
    },
    {
      ...
      href: "mailto:contacto@rztransportes.com",
      icon: (
        ...
        <div className="container mx-auto px-4 md:px-8 py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <a
                href="#contact"
                className="btn-gradient-animated inline-flex items-center gap-2 px-5 md:px-6 py-2.5 md:py-3 text-white font-medium text-sm md:text-base rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/25"
              >
